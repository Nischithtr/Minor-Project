...
\input{./Supporting Files/Packages} % Contains the supporting packages needed to compile the latex document
...
\QRurl{} %Add QR Code URL to the brackets. Only if we are generating.
...
\newpage
\begin{spacing}{1.5}
\input{./Cover Pages/Certificate} %Add the certificates page

\newpage
\input{./Cover Pages/Declaration} %Add the declaration page

\newpage
\input{./Cover Pages/Acknowledgement} %Add the acknowledgement page

\newpage
\pagenumbering{roman} %Add page numbers in roman numeral format

\chapter*{Abstract} %Add the abstract chapter
\input{./Cover Pages/Abstract} %Add the abstract page
...
\input{./Chapter 1/Chapter 1 - Introduction}

%Chapter 2 Basic Principle
\input{./Chapter 2/Chapter 2 - Fundamentals}

%Chapter 3 Design Methodology
\input{./Chapter 3/Chapter 3 - Design}

%Chapter 4 Result
\input{./Chapter 4/Chapter 4 - Results and Inferences}
