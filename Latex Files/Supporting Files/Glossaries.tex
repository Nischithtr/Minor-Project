...
\newglossaryentry{spatial diversity}
{
...
\newglossaryentry{spatial multiplexing}
{
...
\newglossaryentry{rayleigh fading}
{
...
%numbers
\newacronym{4g}{4G}{4th Generation Mobile Systems}
\newacronym{5g}{5G}{5th Generation Mobile Systems}
...
\newacronym{bc}{$B_c$}{Coherence Bandwidth}
...
%G
\newacronym{gt}{$G_t$}{Transmit Antenna Gain}
\newacronym{gr}{$G_r$}{Receive Antenna Gain}
...
%M
\newacronym{mcm}{MCM}{Multi Carrier Modulation}
\newacronym{mimo}{MIMO}{Multiple Input Multiple Output}
\newacronym{miso}{MISO}{Multple Input Single Output}
\newacronym{mli}{MLI}{Maximum Likelihood Estimator}

%N
\newacronym{nsc}{NSC}{Number of Subchannels}

%O
\newacronym{ofdm}{OFDM}{Orthogonal Frequency Division Multiplexing}
\newacronym{ostbc}{OSTBC}{Orthogonal Space Time Block Coding}
...
%T
\newacronym{tg}{$T_g$}{Guard Time}
\newacronym{td}{$T_d$}{Delay Spread}
